...
<head>
    ...
    <link href="{{asset('dashmin/assets/owl.carousel.min.css')}}" rel="stylesheet">
    <link href="{{asset('dashmin/assets/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css')}}" rel="stylesheet" />
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                @if (request()->routeIs('dashboard')) <!-- Ganti 'dashboard' dengan nama route Anda -->
                @include('components.dshb')
                @endif
                @yield('content')
            </div>
            <!-- Sale & Revenue Start -->
